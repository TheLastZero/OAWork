...
public class ExcelUtil {
     ...
     * 
     */
    public ExcelUtil(String fileName, String title, String[] columnName, List<Object[]> dataList,
    ...
    public void export() throws Exception {
        ...
        try {
            ...
            rowm.setHeightInPoints(28);//设置行高
            ...
            HSSFRow rowRowName = sheet.createRow(1);                 // 在索引1的位置创建行(最顶端的行开始的第1行)
...
//                    }
            ...
            if (workbook != null) {
                try {
                	...
                	String fileName2 = "Excel-"+fileName + ".xls";
                    String headStr = "attachment; filename=\"" + new String(fileName2.getBytes("utf-8"), "ISO8859-1") + "\"";

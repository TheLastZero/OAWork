...
<script type="text/javascript">
	...
	function openTaskModifyDialog(rowData) {
		...
		$("#tdate2").val(row.tdate2);
		$("#tresponse").val(row.tresponse);
		...
		<div class="easyui-layout" fit="true">
			...
			<div region="north" border="false" style="height: 280px">
				...
				<div style="padding: 5px;" id="tb">
					<a href="javascript:openTaskModifyDialog()"
				...
				<div id="dlg" class="easyui-dialog"
					style="width: 480px; height: 420px; padding: 10px 20px;"
						...
						<table>
							...
							<tr>
								...
								<td><textarea rows="2" cols="30" name="tname" id="tname"
										class="easyui-validatebox" required="true" disabled="disabled"></textarea></td>
							</tr>
							<tr>
								<!-- 定义下拉框：任务责任人只能是该组成员 -->
								<td>任务责任人：</td>
								<td><input id="userid" name="sysUser.userid"
									class="easyui-combobox" width="50px" required="true"
									disabled="disabled"></td>
							</tr>
							<tr>
								<td>任务下达时间：</td>
								<td><input id="tdate1" type="text" name="tdate1"
									disabled="disabled"></input></td>
							</tr>
							<tr>
								<td>任务工期（天）：</td>
								<td><input type="text" name="tworkday" id="tworkday"
									disabled="disabled"></input></td>
							</tr>
							<tr>
								<td>任务完成时间：</td>
								<td><input id="tdate2" type="text" name="tdate2"></input></td>
							</tr>
							<tr>
								<td>任务完成情况：</td>
								<td><textarea rows="3" cols="30" name="tresponse"
										id="tresponse" class="easyui-validatebox"></textarea></td>
							</tr>
							<tr>
								<td valign="top">备注：</td>
								<td><textarea rows="3" cols="30" name="tremark"
										id="tremark" class="easyui-validatebox" disabled="disabled"></textarea></td>
							</tr>
							<tr>
								<td>排序码：</td>
								<td><input type="text" name="tsortkey" id="tsortkey"
									required="true" disabled="disabled"></input></td>
							</tr>
						</table>
					</form>
				</div>
			...
			<div region="center" border="false">
				...
				<div id="dlg2" class="easyui-dialog"
					style="width: 420px; height: 300px; padding: 10px 20px;"
						...
						<table>
							<tr>
								...
								<td><input type="text" name="iname" id="iname"
									class="easyui-validatebox" required="true" disabled="disabled"></input></td>
							</tr>
							<tr>
								<td valign="top">具体要求：</td>
								<td><textarea rows="5" cols="30" name="irequirement"
										id="irequirement" class="easyui-validatebox" required="true"
							...
							<tr>
								<td>得分：</td>
								<td><input type="text" name="iscore2" id="iscore2"
